...
namespace UnityEngine.UI
{
    ...
    [AddComponentMenu("UI/Round Image", 11)]
    /// <summary>
    ///   Displays a Sprite inside the UI System.
    /// </summary>
    public class RoundImage : MaskableGraphic, ISerializationCallbackReceiver, ILayoutElement, ICanvasRaycastFilter
    {
        ...
        private void TrackRound()
        {
            ...
            if (other != null)
            {
                m_Round = other.r.x;                 //When it does, transfer the radius value to this script
        ...
        static List<RoundImage> m_TrackedTexturelessImages = new List<RoundImage>();
        ...
        private static void TrackImage(RoundImage g)
        {
            if (!s_Initialized)
            {
        ...
        private static void UnTrackImage(RoundImage g)
        {
        ...
        public void Validate()
        {
            if (r_Material == null)
            {
                r_Material = new Material(Shader.Find("UI/RoundedCorners/RoundedCorners"));
            }
